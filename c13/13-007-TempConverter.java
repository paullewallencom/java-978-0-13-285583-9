...
/**
    This class displays a window with a slider compnent.
    The user can convert the Celsius temperature from 
    ...
    */
    ...
    private class SliderListener implements ChangeListener
    {
        public void stateChanged( ChangeEvent e )
        {
            ...
            // Store the Celsius temp in it's display field.
            celsiusTemp.setText( Double.toString( celsius ) );

            // Store the Fahrenheit temp in it's display field.
