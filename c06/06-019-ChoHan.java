...
public class ChoHan
{
    public static void main( String[] args )
    {
        ...
        {
            System.out.println( "-----------------------------" );
            System.out.println( "Now playing round %d.\n", round + 1 );
            ...
            roundResults( dealerk player1, player2 );
        }
    ...
    */
    ...
    public static void roundResults( Dealer dealer, Player player1, Player player2 )
    {
        ...
        System.out.printf( "The dealer rolled %d and %d.\n", 
            dealer.getDie1Value(), dealer.get2DieValue() );
    ...
    */
    ...
    public static void displayGrandWinner( Player player1, Player player2 )
    {
        ...
        if ( player1.getPoints() > player2.getPoints() )
            ...
            System.out.println( players2.getName() + " is the grand winner!" );
        else
